	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<h2 style="text-align:center; color:#FF0000; font-family: 'Courier New', Courier, monospace">Terima kasih telah mengirimkan permintaan ke Tim NELAYANID. 
				Kami akan menghubungi Anda kembali setelah kami memverifikasi pembayaran Anda..<br>
				Anda dapat masuk untuk melihat status pemrosesan permintaan Anda menggunakan email dan Nomor ID Nasional sebagai kata sandi..</h2>
			</ul>
